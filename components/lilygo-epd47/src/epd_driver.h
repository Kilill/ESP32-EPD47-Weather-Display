...
/**
 * @brief Darken / lighten a circular area for a given time.
 *
 * @param x0    Center X coordinate of the circle.
 * @param y0    Center Y coordinate of the circle.
...
/**
 * @brief Clear a circular area by flashing it.
 *
 * @param x0         Center X coordinate of the circle.
 * @param y0         Center Y coordinate of the circle.
 * @param r          Radius of the circle in pixels.
...
/**
 * @brief Clear a circular area with default parameters.
 *
 * @param x0 Center X coordinate of the circle.
 * @param y0 Center Y coordinate of the circle.
 * @param r  Radius of the circle in pixels.
